    ...
    <div className="container mx-auto p-4 sm:p-6 mt-6 sm:mt-10">
      <div className="bg-white shadow-xl rounded-lg overflow-hidden md:flex md:items-start">
        ...
        <div className="md:w-1/2 p-4 sm:p-8 flex flex-col justify-center">
          ...
          <p className="text-3xl sm:text-4xl font-semibold text-blue-600 mb-4">
          ...
          <button className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 text-base sm:text-lg shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50">
            Adicionar ao Carrinho
          </button>

          <Link
            to="/"
            className="text-blue-600 hover:text-blue-800 hover:underline mt-8 block text-sm sm:text-base"
          >
